...
walkRight = [pygame.transform.flip(playerLeft,30,0)]
walkLeft = [playerLeft]
PlayTime= 25
totalLives = 3
lifeImage = pygame.transform.scale(player, (20,20))
...
class Weapon:
    ...
    def draw(self,win):
        pygame.draw.line(win,black,(self.x+10,self.y),(self.x+10,self.y+300),4)
...
bounce=False
bubble= Bubble(randint(20,400),200)
arrow=[]
run = True
...
button_01 = Button("1 Player", (190, 200))
